...
import bin_icon from '../../components/assets/delete-button.svg';
                        ...
                        <div className='head-of-block'>
                            ...
                            <div className='buttons'>
                                ...
                                <button className='delete-button'
                                    ...
                                    <svg width="32" height="32" className='delete-icon' viewBox='0 0 32 32'>
                                        <g>
                                            <polygon fill="none" points="25,11 7,11 9,31    23,31  "  stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                                            ...
                                            <polyline fill="none" points="13,11 13,7 19,7    19,11  "  stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                                        </g>
                                    </svg>
                                </button>
                            </div>
